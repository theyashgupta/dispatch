...
| T-103-01 | Information Disclosure                            | `services/domain/vault.ts#listKeys`, `routes/vault.route.ts`, `shared/types.ts#VaultKeySummary`                                                                                                                  | The read path opens only `vault.json` and never `values.env`; `VaultKeySummary` is a closed five-field shape (name, purpose, createdAt, updatedAt, filled) with no value field and no length-proportional field, so no route can return a value or a size hint structurally. The `vault-no-read-back` check sweeps eight read-back path shapes plus the board payload plus live SSE frames plus all four error paths for a seeded sentinel, and was proven able to fail by temporarily adding a read-back route.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
