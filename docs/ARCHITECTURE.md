...
| T-103-01 | Information Disclosure                            | `services/domain/vault.ts#listKeys`, `routes/vault.route.ts`, `shared/types.ts#VaultKeySummary`                                                                                                                  | The list path opens only `vault.json` and never `values.env`; `VaultKeySummary` is a closed six-field shape (name, purpose, createdAt, updatedAt, filled, hasPrevious) with no value field and no length-proportional field, so no route can return a current value or a size hint structurally. The one deliberate value read, `GET /vault/:name/previous` (`services/domain/vault.ts#readPrevious`), opens only the sealed `previous.env` (the single value each key held before its latest rotate, moved there verbatim by `setValue`) and never `values.env`, so a current value stays unreachable from any GET; the guard seals `previous.env` exactly as it seals `values.env` (`T-105-04`). The `vault-no-read-back` check sweeps eight read-back path shapes plus the board payload plus live SSE frames plus all four error paths for a seeded sentinel, and was proven able to fail by temporarily adding a read-back route.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
